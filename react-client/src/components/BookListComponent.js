                                ...
                                books.map(
                                    book =>
                                        <tr >
                                            ...
                                            <td >
                                                <Link to={`/edit-book/${book.id}`} className="btn btn-secondary " style={{margin:2}} >Изменить</Link>
                                                <br/>
                                                <button className="btn btn-danger"  style={{margin:2}} onClick={()=>deleteBook(book.id)}>Удалить</button>
                                            </td>
                                        </tr>
                                ):
                                    <tr>
