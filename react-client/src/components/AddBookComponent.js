...
const saveOrUpdate=(e)=>{
    ...
    if(id!==undefined && id!==null){
        ...
        bookService.updateBook(updBook.id,updBook).then(()=>{
            navigate("/books")
        })
    }
    else{
                            ...
                            <form>
                                        ...
                                        <div className="form-group mb-2">
                                            <label className = "form-label">
                                                ...
                                                <input
                                                    ...
                                                    value ={author.name}
                                                    required={true}
                                                    onChange = {e=> {authorChange(index,e.target.value)}}
                                                />
                                                    {
                                                        index===0 ?
                                                        null :
                                                        <button className="btn btn-outline-danger"  type="button" onClick={()=>{deleteAuthor(index)}}>Удалить</button>
                                                    }
                                            </div></label>
                                ...
                                <div>
                                    ...
                                    <div style={{textAlign:"right"}}>
                                        <br/>
                                    <Link to="/books" className="btn btn-danger" style={{marginRight:2}}>Отмена</Link>
